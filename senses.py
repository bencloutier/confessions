...
_LEMMA_GLOSS_OVERRIDE = {
    ...
    # Numerals: Collatinus tags these as adjectives, which don't match
    # Whitaker's NUM-tagged entries, so the POS-gated stem search misses them.
    "unus": "one",
    "duo": "two",
    "tres": "three",
    "quattuor": "four",
    ...
    "novem": "nine",
    "decem": "ten",
    # Common words the stem search still misses for one reason or another.
    "ultimus": "last, farthest, final",
    "ulterior": "farther, more distant",
    "semel": "once",
    "en": "behold!, see!, lo!",
    "vi": "by force (abl. of vis)",
    "excultus": "cultivated, refined, adorned",
    "sodomitae": "the Sodomites (people of Sodom)",
    # Proper nouns (biblical/historical figures named in the text).
    "isaac": "Isaac",
    "esau": "Esau",
    "ioseph": "Joseph",
    "iohannes": "John",
    ...
    "symmachus": "Symmachus",
    "eversus": "overturned, destroyed",
    "expositus": "set forth, exposed, explained",
    "obtritus": "crushed, trampled",
    "avulsus": "torn away, wrenched off",
    "inrepo": "to creep in, steal in",
    "flabilis": "airy, that can be breathed/blown",
    "iordanes": "the Jordan (river)",
    "galatae": "the Galatians",
    "martyr": "martyr",
    # People and places from Augustine's own biography.
    "alypius": "Alypius (Augustine's close friend and fellow convert)",
    "monnica": "Monnica (Augustine's mother)",
    "ponticianus": "Ponticianus (an African official who visited Augustine)",
    "romanianus": "Romanianus (Augustine's wealthy patron and friend)",
    "simplicianus": "Simplicianus (priest in Milan, mentor to Ambrose and Augustine)",
    "vindicianus": "Vindicianus (proconsul and physician who advised Augustine)",
    "elpidius": "Elpidius",
    "hierius": "Hierius (a Roman orator Augustine admired)",
    "cassiciacum": "Cassiciacum (villa where Augustine retreated before baptism)",
    "hierusalem": "Jerusalem",
    "hippocrates": "Hippocrates (the Greek physician)",
    "helias": "Elijah",
    "thagastensis": "of Thagaste (Augustine's birthplace)",
    "daviticus": "Davidic, of David",
